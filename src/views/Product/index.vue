...
<script>
import ParductParam from '../../components/ProductParam'
export default {
    created(){
        this.axiosFine.v(this);
        this.getProductInfo();
    },
    mounted(){
    ...
    methods:{
        getProductInfo(){
            ...
            this.axiosFine.shop.products({
                noQuestion : true,    //开启使用参数值直接拼接的接口路径上
                data : id,
                bindName : 'info',
                success : res=>{
                    console.log(res);
        ...
        .content{
            ...
            .item-video{
                ...
                .video{
                    ...
                    opacity:1;
                    &.slideDown{
                    animation:slideDown .6s linear;     //调用哪个动画？ 几秒？ 效果？
                    top:50%;
                    }
                    &.slideUp{
