  ...
  <div class="login">
    ...
    <div class="footer">
      <div class="footer-link">
        ...
        <a href="javascript:;" target="_blank">vue@cli4.X</a><span>|</span>
        <a href="javascript:;" target="_blank">Axios</a><span>|</span>
        <a href="javascript:;" target="_blank">vue-awesome-swiper + element-ui + Sass</a>
      </div>
      <p class="copyright">2020年5月31号 @lindunwei</p>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods:{
    login(){
      ...
      this.axiosFine.login.LoginIn({
          type : 'post',
        //   repeat : true,    //开启防止重复提交
          data : data,
          success : res => {
                console.log(res);
